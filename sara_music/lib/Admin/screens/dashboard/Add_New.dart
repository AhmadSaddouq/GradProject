    ...
    if(Gendeer.text.isNotEmpty&& phonenum.text.isNotEmpty&&UserName.text.isNotEmpty && Emaill.text.isNotEmpty && dateinput.text.isNotEmpty && Password.text.isNotEmpty){
       ...
       if(res.statusCode==400){
            Map<String, dynamic> DB = jsonDecode(res.body);
                if(DB['keyValue']['name'] != ""||DB['keyValue']['name'] != null){
          return _displayErrorMotionToast4(context);
           }
             if(DB['keyValue']['Phone'] != ""){
          return _displayErrorMotionToast5(context);
           }
             if(DB['keyValue']['email'] != ""){
          return _displayErrorMotionToast6(context);
           }
